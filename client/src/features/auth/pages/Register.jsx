...
import { IcoUser, IcoMail, IcoPhone, IcoLock, IcoClose } from "../components/AuthIcons";
        ...
        <form className="auth-form" onSubmit={onSubmit} noValidate>
          ...
          <div className="auth-field">
            ...
            <div className="auth-input-wrap">
              <span className="auth-input-icon"><IcoUser /></span>
              <input
                id="r-name" className="auth-input" type="text" name="fullname"
          ...
          <div className="auth-field">
            ...
            <div className="auth-input-wrap">
              ...
              <input
                id="r-email" className="auth-input" type="email" name="email"
          ...
          {/* Contact */}
          <div className="auth-field">
            <label className="auth-label" htmlFor="r-contact">Contact Number</label>
            <div className="auth-input-wrap">
              <span className="auth-input-icon"><IcoPhone /></span>
              <input
                id="r-contact" className="auth-input" type="tel" name="contact"
                value={form.contact} onChange={onChange}
                placeholder="99999 99999" autoComplete="tel" inputMode="numeric" required
              />
            </div>
          </div>
          ...
          {/* Password */}
          <div className="auth-field">
            <label className="auth-label" htmlFor="r-pass">Password</label>
            <div className="auth-input-wrap">
              <span className="auth-input-icon"><IcoLock /></span>
              <input
                id="r-pass" className="auth-input" type="password" name="password"
          ...
          <label className="auth-checkbox-row" htmlFor="r-seller">
            <input
              id="r-seller" className="auth-checkbox" type="checkbox"
              name="isSeller" checked={form.isSeller} onChange={onChange}
            />
            <span className="auth-checkbox-label">Register as a Seller / Merchant</span>
          </label>
