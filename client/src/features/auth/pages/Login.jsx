  ...
  return (
    <div className="min-h-screen bg-zinc-50 flex items-center justify-center p-6 font-sans">
      <div className="w-full max-w-md bg-white border border-zinc-200 rounded-xl p-8 shadow-sm">
        <h2 className="text-2xl font-semibold text-zinc-900 tracking-tight mb-1">Welcome back</h2>
        ...
        <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
          ...
          <div>
            <div className="flex justify-between items-center mb-1">
              ...
              <a href="#forgot" className="text-xs text-zinc-400 hover:text-zinc-900 transition" onClick={(e) => e.preventDefault()}>Forgot?</a>
            </div>
            <input
              type="password"
              placeholder="••••••••"
        ...
        <p className="mt-6 text-center text-xs text-zinc-500">
          ...
          <Link to="/register" className="font-semibold text-zinc-900 hover:underline">Register</Link>
        </p>
      </div>
    </div>
  );
